...
export default function MobileHeader({ isOpen, setIsOpen }: MobileHeaderProps) {
  return (
    <header className="lg:hidden fixed top-0 left-0 right-0 h-20 bg-[var(--color-brand-dark)] text-white px-4 sm:px-6 flex items-center justify-between z-50 shadow-xl border-b border-white/5 gap-2">
